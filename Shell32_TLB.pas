...
// PASTLWTR : 1.2
// File generated on 2012/05/12 9:49:35 from Type Library described below.

// ************************************************************************  //
// Type Lib: C:\WINDOWS\system32\SHELL32.dll (1)
...
//   ヒント: IShellDispatch2.ShellExecute のパラメータ 'File' の名前が 'File_' に変更されました。
//   ヒント: 'IWebWizardHost' の 'Property' メンバーの名前が 'Property_' に変更されました。
// ************************************************************************ //
...
const
  ...
  IID_ISearchCommandExt: TGUID = '{1D2EFD50-75CE-11D1-B75A-00A0C90564FE}';
  ...
  DIID_DSearchCommandEvents: TGUID = '{60890160-69F0-11D1-B758-00A0C90564FE}';
  CLASS_SearchCommand: TGUID = '{B005E690-678D-11D1-B758-00A0C90564FE}';
  ...
  IID_IPassportClientServices: TGUID = '{B30F7305-5967-45D1-B7BC-D6EB7163D770}';
  CLASS_PassportClientServices: TGUID = '{2D2307C8-7DB4-40D6-9100-D52AF4F97A5B}';

// *********************************************************************//
// Declaration of Enumerations defined in Type Library                    
// *********************************************************************//
// Constants for enum SearchCommandExecuteErrors
type
  SearchCommandExecuteErrors = TOleEnum;
const
  SCEE_PATHNOTFOUND = $00000001;
  SCEE_MAXFILESFOUND = $00000002;
  SCEE_INDEXSEARCH = $00000003;
  SCEE_CONSTRAINT = $00000004;
  SCEE_SCOPEMISMATCH = $00000005;
  SCEE_CASESENINDEX = $00000006;
  SCEE_INDEXNOTCOMPLETE = $00000007;
...
// *********************************************************************//
  ...
  ISearchCommandExt = interface;
  ISearchCommandExtDisp = dispinterface;
  ...
  IPassportClientServicesDisp = dispinterface;
...
// *********************************************************************//
  ISearchCommandExt = interface(IDispatch)
    ...
    function Get_ProgressText: WideString; safecall;
    procedure SaveSearch; safecall;
    function GetErrorInfo(out pbs: WideString): SYSINT; safecall;
    procedure SearchFor(iFor: SYSINT); safecall;
    procedure GetScopeInfo(const bsScope: WideString; out pdwScopeInfo: SYSINT); safecall;
    procedure RestoreSavedSearch(var pvarFile: OleVariant); safecall;
    procedure Execute(var RecordsAffected: OleVariant; var Parameters: OleVariant; Options: Integer); safecall;
    procedure AddConstraint(const Name: WideString; Value: OleVariant); safecall;
    function GetNextConstraint(fReset: WordBool): DFConstraint; safecall;
    property ProgressText: WideString read Get_ProgressText;
  end;

// *********************************************************************//
// DispIntf:  ISearchCommandExtDisp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {1D2EFD50-75CE-11D1-B75A-00A0C90564FE}
// *********************************************************************//
  ISearchCommandExtDisp = dispinterface
    ['{1D2EFD50-75CE-11D1-B75A-00A0C90564FE}']
    procedure ClearResults; dispid 1;
    procedure NavigateToSearchResults; dispid 2;
    property ProgressText: WideString readonly dispid 3;
    procedure SaveSearch; dispid 4;
    function GetErrorInfo(out pbs: WideString): SYSINT; dispid 5;
    procedure SearchFor(iFor: SYSINT); dispid 6;
    procedure GetScopeInfo(const bsScope: WideString; out pdwScopeInfo: SYSINT); dispid 7;
    procedure RestoreSavedSearch(var pvarFile: OleVariant); dispid 8;
    procedure Execute(var RecordsAffected: OleVariant; var Parameters: OleVariant; Options: Integer); dispid 100;
    procedure AddConstraint(const Name: WideString; Value: OleVariant); dispid 101;
    function GetNextConstraint(fReset: WordBool): DFConstraint; dispid 102;
  end;
...
// *********************************************************************//
// DispIntf:  DSearchCommandEvents
// Flags:     (4096) Dispatchable
// GUID:      {60890160-69F0-11D1-B758-00A0C90564FE}
// *********************************************************************//
  DSearchCommandEvents = dispinterface
    ['{60890160-69F0-11D1-B758-00A0C90564FE}']
    procedure SearchStart; dispid 1;
    procedure SearchComplete; dispid 2;
    procedure SearchAbort; dispid 3;
    procedure RecordsetUpdate; dispid 4;
    procedure ProgressTextChanged; dispid 5;
    procedure SearchError; dispid 6;
    procedure SearchRestored; dispid 7;
  end;
...
// *********************************************************************//
  IPassportClientServices = interface(IDispatch)
    ...
    function MemberExists(const bstrUser: WideString; const bstrPassword: WideString): WordBool; safecall;
  end;

// *********************************************************************//
// DispIntf:  IPassportClientServicesDisp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {B30F7305-5967-45D1-B7BC-D6EB7163D770}
// *********************************************************************//
  IPassportClientServicesDisp = dispinterface
    ['{B30F7305-5967-45D1-B7BC-D6EB7163D770}']
    function MemberExists(const bstrUser: WideString; const bstrPassword: WideString): WordBool; dispid 0;
  end;
...
// create instances of the default interface IShellLinkDual exposed by              
...
// create instances of the default interface IShellFolderViewDual2 exposed by              
// the CoClass ShellFolderView. The functions are intended to be used by             
// clients wishing to automate the CoClass objects exposed by the         
// server of this typelibrary.                                            
// *********************************************************************//
  CoShellFolderView = class
    class function Create: IShellFolderViewDual2;
    class function CreateRemote(const MachineName: string): IShellFolderViewDual2;
  end;

// *********************************************************************//
// The Class CoShell provides a Create and CreateRemote method to          
// create instances of the default interface IShellDispatch exposed by              
...
// *********************************************************************//
// The Class CoWebViewFolderContents provides a Create and CreateRemote method to          
// create instances of the default interface IShellFolderViewDual exposed by              
// the CoClass WebViewFolderContents. The functions are intended to be used by             
// clients wishing to automate the CoClass objects exposed by the         
// server of this typelibrary.                                            
// *********************************************************************//
...
// *********************************************************************//
// The Class CoSearchCommand provides a Create and CreateRemote method to          
// create instances of the default interface IDispatch exposed by              
// the CoClass SearchCommand. The functions are intended to be used by             
// clients wishing to automate the CoClass objects exposed by the         
// server of this typelibrary.                                            
// *********************************************************************//
  CoSearchCommand = class
...
// *********************************************************************//
// The Class CoPassportClientServices provides a Create and CreateRemote method to          
// create instances of the default interface IPassportClientServices exposed by              
// the CoClass PassportClientServices. The functions are intended to be used by             
// clients wishing to automate the CoClass objects exposed by the         
// server of this typelibrary.                                            
// *********************************************************************//
  CoPassportClientServices = class
    class function Create: IPassportClientServices;
    class function CreateRemote(const MachineName: string): IPassportClientServices;
  end;
...
class function CoShellFolderView.Create: IShellFolderViewDual2;
begin
  Result := CreateComObject(CLASS_ShellFolderView) as IShellFolderViewDual2;
end;

class function CoShellFolderView.CreateRemote(const MachineName: string): IShellFolderViewDual2;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_ShellFolderView) as IShellFolderViewDual2;
end;
...
class function CoSearchCommand.Create: IDispatch;
begin
  Result := CreateComObject(CLASS_SearchCommand) as IDispatch;
end;

class function CoSearchCommand.CreateRemote(const MachineName: string): IDispatch;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_SearchCommand) as IDispatch;
end;
...
class function CoPassportClientServices.Create: IPassportClientServices;
begin
  Result := CreateComObject(CLASS_PassportClientServices) as IPassportClientServices;
end;

class function CoPassportClientServices.CreateRemote(const MachineName: string): IPassportClientServices;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_PassportClientServices) as IPassportClientServices;
end;
